...
<div className="relative w-full shadow-sm rounded-xl overflow-hidden my-4">
  ...
  <div className="absolute inset-0  bg-opacity-30 flex flex-col justify-center items-center text-white md:p-4 p-auto text-center">
    <h2 className="md:text-2xl text-sm pt-8 md:py-5 font-bold md:w-full w-1/2">It avoids subjective claims or<br></br> exaggeration that might raise red<br/> flags legally</h2>
